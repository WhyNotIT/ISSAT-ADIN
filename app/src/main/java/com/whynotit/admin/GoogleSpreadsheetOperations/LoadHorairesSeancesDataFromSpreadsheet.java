 ...
 */
public class LoadHorairesSeancesDataFromSpreadsheet extends AsyncTask<Void, Void, List<String>> {
    ...
    public LoadHorairesSeancesDataFromSpreadsheet(GoogleAccountCredential credential, Activity activity, String spreadsheetId, String range, Object listnerOrDialog) {
    ...
    protected void onPostExecute(List<String> output) {
        ...
        if (listnerOrDialog instanceof DialogNetworkOperation) {
            ...
            ((SplashActivity.SpreadSheetLoadingListner)listnerOrDialog).onLoadingHoraireDone();
        }
